...
MESH_DRAW_IRISES = False
MESH_COLOR = (255, 255, 80)
MESH_THICKNESS = 1
MESH_ALPHA = 1.00
MESH_POINT_RADIUS = 2
MESH_GLOW_STRENGTH = 0.92

# Local face lighting (applied only around detected face landmarks)
FACE_LIGHT_ENABLED = True
FACE_LIGHT_STRENGTH = 0.82
FACE_LIGHT_BLUR = 81
...
LANDMARK_TRIGGER_MIN_INTERVAL_SECONDS = 0.45
TRACKING_LANDMARK_EVERY_N_FRAMES = 3
...
TEMPORAL_WINDOW_FPS = 30
WEAK_SIGNAL_CONFIDENCE_THRESHOLD = 0.34
STABLE_CHANGE_CONFIDENCE_THRESHOLD = 0.60
FORCE_BREAK_CONFIDENCE_THRESHOLD = 0.75
HIGH_CONFIDENCE_OVERRIDE_THRESHOLD = 0.75
HOLD_BREAK_CONFIDENCE_DELTA = 0.20
...
EMOTION_HOLD_SECONDS = 1.2
HOLD_SWITCH_MARGIN = 0.20
HOLD_OVERRIDE_MARGIN = 0.26
FEATURE_BASELINE_ALPHA = 0.92
USE_EMA_SMOOTHING = True
EMA_ALPHA = 0.40
GEOMETRY_APPLY_RAW_MAX_CONFIDENCE = 0.50
GEOMETRY_OVERRIDE_MIN_STRENGTH = 0.70
TEMPORAL_STRONG_EMOTION_THRESHOLD = 0.60
